    ...
    if(!file.exists(out_path)){
      tryCatch({ 
        ...
        res <- lapply(
          ...
          inefficiency_covariates = list(scalar_variables=c("lnAgeYr","lnYerEdu","CrpMix"),factor_variables=c("Female","Ecozon","Extension","Credit","OwnLnd","EqipMech")),
          adoption_covariates     = list(scalar_variables=c("lnAgeYr","lnYerEdu","CrpMix"),factor_variables=c("Female","Ecozon","Extension","Credit","OwnLnd","EqipMech")),
