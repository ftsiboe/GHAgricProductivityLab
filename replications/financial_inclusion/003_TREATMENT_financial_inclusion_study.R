# =============================================================================
#  TREATMENT EFFECT WORKFLOW - FINANCIAL INCLUSION STUDY 
# =============================================================================
#  General Description:
# -----------------------------------------------------------------------------
# This script automates the estimation and summarization of
# treatment effects for the “FINANCIAL INCLUSION” project replication.
# 
...
# Executed if running locally (Windows) or on SLURM jobs named “te_all” or “te_fin”
if (grepl("WINDOWS", sysname) || Sys.getenv("SLURM_JOB_NAME") %in% c("te_all", "te_fin")) {
